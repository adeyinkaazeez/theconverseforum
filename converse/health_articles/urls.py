...
app_name = 'health_articles'
urlpatterns = [
      path('', views.post_list, name='health_post_list'),
      path('all_health_posts_view', views.list_load_Health_posts_view, name='all_health_posts_view'),
      path('create_health_article_post/', views.Create_Post,name='create_post'),
