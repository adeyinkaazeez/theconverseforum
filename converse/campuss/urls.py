...
app_name = 'campuss'
urlpatterns = [
       path('', views.post_list, name='campus_post_list'),
       path('all_campus_posts_view', views.list_load_campus_posts_view, name='all_campus_posts_view'),
       path('create_campus_post/', views.Create_Post,name='create_post'),
