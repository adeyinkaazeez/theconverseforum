...
app_name = 'howtos'
urlpatterns = [
     path('', views.post_list, name='howto_post_list'),
     path('all_howto_posts_view', views.list_load_Howto_posts_view, name='all_howto_posts_view'),
     path('create_learning_post/', views.Create_Post,name='create_post'),
