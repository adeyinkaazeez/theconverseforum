...
app_name = 'cultures'
urlpatterns = [
     path('', views.post_list, name='culture_post_list'),
     path('all_cultural_posts_view', views.list_load_cultural_posts_view, name='all_cultural_posts_view'),
     path('create_culture_post/', views.Create_Post,name='create_post'),
