...
app_name = 'happening'
urlpatterns = [
     path('', views.post_list, name='happenings_post_list'),
     path('all_citizen_posts_view', views.list_load_Happening_posts_view, name='all_citizen_posts_view'),
     path('create_happening_post/', views.Create_Post,name='create_post'),
