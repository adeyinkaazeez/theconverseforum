...
app_name = 'celeb'
urlpatterns = [
      path('', views.post_list, name='celebrity_post_list'),
      path('all_celebrity_posts_view', views.list_load_celeb_posts_view, name='all_celebrity_posts_view'),
      path('create_celebrity_post/', views.Create_Post,name='create_post'),
