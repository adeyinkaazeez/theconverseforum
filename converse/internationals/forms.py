...
class PostForm(forms.ModelForm):
   ...
   class Meta:
    ...
    fields = fields =  [ 'title' , 'tags','news_image', 'caption', 'body', 'news_image_two', 'caption_two', 'news_image_three', 'caption_three', 'news_image_four', 'caption_four']
    widgets = {
