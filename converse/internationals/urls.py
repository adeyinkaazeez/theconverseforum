...
app_name = 'internationals'
urlpatterns = [
     path('', views.post_list, name='international_post_list'),
     path('all_international_posts_view', views.list_load_International_posts_view, name='all_international_posts_view'),
     path('edit_post/<int:pk>', views.Update_Post, name='edit_post'),
     path('delete/<int:pk>', views.delete_post, name='post-delete'),
     path('create_international_news_post/', views.Create_Post,name='create_post'),
