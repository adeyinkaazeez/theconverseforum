...
app_name = 'loves'
urlpatterns = [
     path('all_love_posts_view', views.list_load_Love_posts_view, name='all_love_posts_view'),
     path('', views.post_list, name='love_post_list'),
     path('create_love_post/', views.Create_Post,name='create_post'),
