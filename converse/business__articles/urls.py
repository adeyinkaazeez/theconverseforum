...
app_name = 'business__articles'
urlpatterns = [
      path('', views.post_list, name='business_article_post_list'),
      path('all_business_article_posts_view', views.list_load_business_article_posts_view, name='all_business_article_posts_view'),
      path('create_business_article_post/', views.Create_Post,name='create_post'),
