...
app_name = 'sciences'
urlpatterns = [
      path('', views.post_list, name='st_post_list'),
      path('all_science_posts_view', views.list_load_Science_posts_view, name='all_science_posts_view'),
      path('edit_post/<int:pk>', views.Update_Post, name='edit_post'),
      path('create_science_and_tech_post/', views.Create_Post,name='create_post'),
