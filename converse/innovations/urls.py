...
urlpatterns = [
     path('', views.post_list, name='innovation_post_list'),
     path('all_innovative_posts_view', views.list_load_Innovative_posts_view, name='all_innovative_posts_view'),
     path('create_innovative_article/', views.Create_Post,name='create_post'),
