...
app_name = 'personalitys'
urlpatterns = [
      path('', views.post_list, name='personality_post_list'),
      path('all_personality_posts_view', views.list_load_Personality_posts_view, name='all_personality_posts_view'),
      path('create_personality_post/', views.Create_Post,name='create_post'),
