...
app_name = 'religions'
urlpatterns = [
      path('', views.post_list, name='religion_post_list'),
     path('all_religion_posts_view', views.list_load_Religion_posts_view, name='all_religion_posts_view'),
     path('create_religion_article/', views.Create_Post,name='create_post'),
