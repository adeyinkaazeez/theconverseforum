...
app_name = 'sports'
urlpatterns = [
     path('', views.post_list, name='sport_post_list'),
     path('all_sport_posts_view', views.list_load_Sport_posts_view, name='all_sport_posts_view'),
     path('create_sport_post/', views.Create_Post,name='create_post'),
