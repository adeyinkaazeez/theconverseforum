...
app_name = 'lifestyles'
urlpatterns = [
     path('all_lifestyle_posts_view', views.list_load_Lifestyle_posts_view, name='all_lifestyle_posts_view'),
     path('', views.post_list, name='lifestyle_post_list'),
     path('create_lifestyle_article_post/', views.Create_Post,name='create_post'),
