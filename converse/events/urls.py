...
app_name = 'events'
urlpatterns = [
     path('', views.post_list, name='event_post_list'),
     path('all_event_posts_view', views.list_load_Event_posts_view, name='all_event_posts_view'),
     path('create_event_post/', views.Create_Post,name='create_post'),
